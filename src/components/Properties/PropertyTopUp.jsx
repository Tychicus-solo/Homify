...
import { paymentHistory, propertyLinks, InvestmentHomes } from "../../data";
...
const MyPropertyDetails = () => {
  ...
  const products = InvestmentHomes.find((myInvest) => myInvest.id == id);
  ...
  return (
    <div className="min-h-screen w-screen pb-12">
      <div className=" w-[70%] mx-auto">
        ...
        <div>
          <img src={products.img} className="w-[100%] h-[25rem] mt-10" alt="" />
        </div>
