    ...
    <div className="h-screen">
      <div className=" w-[100%] bg-[#e5e5e5] mt-20 mx-auto">
        <div className=" w-[85%] mx-auto">
          <div className="flex flex-col align-items-end max-sm:items-center sm:flex-row sm:justify-between">
          ...
          <div className="w-[100%] flex flex-col sm:flex-row max-sm:pb-8 max-sm:items-center mt-14">
            {InvestmentHomes.map((invest) => (
              ...
              >
                <NavLink
                  to={`/properties/myproperties/${invest.id.toString()}`}
                >
